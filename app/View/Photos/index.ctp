		...
		<table class="photo_list_1" border="0" cellspacing="20px" cellpadding="0px">
		  <tr>
			<td class="anh_ngang" colspan="2">
				<span class="anh_ngang_pt" style="background-image:url(img/image/demo.jpg);<?php echo background_size_list1('img/image/demo.jpg','ngang');?>">
			...
			<td class="anh_vuong" >
				<span class="anh_vuong_pt" style="background-image:url(img/image/demo.jpg);<?php echo background_size_list1('img/image/demo.jpg','vuong');?>">
		  ...
		  <tr>
			...
			<td class="anh_dung" rowspan="2">
				<span class="anh_dung_pt" style="background-image:url(img/image/demo.jpg);<?php echo background_size_list1('img/image/demo.jpg','dung');?>">
					<table class="ca-icon" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td class="like-icon">
							<span class="vien-icon">
...
<!-- photo list 2-->	
		<table class="photo_list_2" border="0" cellspacing="20px" cellpadding="0">
			  <tr>
				<td class="anh_vuong">
					<span class="anh_vuong_pt" style="background-image:url(img/image/demo.jpg);<?php echo background_size_list2('img/image/demo.jpg','vuong');?>"></span>
				</td>
				<td class="anh_ngang" rowspan="3">
					<span class="anh_ngang_pt" style="background-image:url(img/image/demo.jpg);<?php echo background_size_list2('img/image/demo.jpg','ngang');?>"></span>
				</td>
			  </tr>
			  <tr>
				<td class="anh_vuong">
...
<!-- photo list 3-->	
	  <table class="photo_list_3" border="0" cellspacing="20px" cellpadding="0">
          <tr>
            <td class="anh_ngang">
				<span class="anh_ngang_pt" style="background-image:url(img/image/demo.jpg);<?php echo background_size_list3('img/image/demo.jpg');?>"></span>
			</td>
          </tr>
        </table>	</td>
  </tr>
